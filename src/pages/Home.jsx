            ...
            <section className="bg-white py-16 md:py-24">
                <div className="container mx-auto px-4 max-w-6xl">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 items-center justify-center">
                        ...
                        {[
                            { src: spotify, alt: "Brand A Logo" },
                            { src: google, alt: "Brand B Logo" },
                            { src: stripe, alt: "Brand C Logo" },
                            { src: youtube, alt: "Brand D Logo" },
                            { src: microsoft, alt: "Brand E Logo" },
                            { src: medium, alt: "Brand F Logo" },
                            { src: zoom, alt: "Brand G Logo" },
                            { src: uber, alt: "Brand H Logo" },
                            { src: grab, alt: "Brand I Logo" },
                        ].map((brand, index) => (
                            <div
