        ...
        <div>
            <div className="flex min-h-screen bg-white">
                ...
                <div className="w-1/2 flex flex-col justify-center items-center p-8 lg:p-16">
                    ...
                    <form action={loginUser} className="w-full max-w-sm">
                        <div className="mb-4">
                        ...
                        <SubmitButton title={'Sign In'} className="w-1/2 bg-event bg-purple-800 text-white py-2 rounded-md hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-event-purple-light focus:ring-opacity-50 transition-colors duration-200 m-20" />
                        {/* <button
                            type="submit"
