                    ...
                    <div className='w-full max-w-sm'>
                        <form className='mb-5' action="">
                            ...
                            <div className='mb-4'>
                                ...
                                <input type="email" id='email' placeholder='Enter your email' className='w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500' />
                            </div>
                            <div className='mb-5'>
